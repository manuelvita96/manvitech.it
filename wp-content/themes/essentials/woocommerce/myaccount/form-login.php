...
<?php if ( 'yes' === get_option( 'woocommerce_enable_myaccount_registration' ) ) { ?>
		...
		<div class="col-12 col-md-6">
			<h4 class="font-weight-bold text-heading-default"><?php esc_html_e( 'Login', 'essentials' ); ?></h4>
<?php }else{ ?>
	<div class="col-12 offset-md-3 col-md-6">
		<h4 class="font-weight-bold text-heading-default text-center"><?php esc_html_e( 'Login', 'essentials' ); ?></h4>
	<?php } ?>
...
<?php if ( 'yes' === get_option( 'woocommerce_enable_myaccount_registration' )  ) : ?>
	...
	<div class="col-12 col-md-6">
		...
		<h4 class="font-weight-bold text-heading-default"><?php esc_html_e( 'Register', 'essentials' ); ?></h4>

...
function pixfort_demo_forms(){
    ...
    $demo = array(
        ...
        'import_preview_image_url'     => 'https://pixfort-space.sfo2.cdn.digitaloceanspaces.com/wordpress/core/data/thumbnails/one_click/forms/simple-contact-form.webp',
    ...
    $demo = array(
        ...
        'import_preview_image_url'     => 'https://pixfort-space.sfo2.cdn.digitaloceanspaces.com/wordpress/core/data/thumbnails/one_click/forms/newsletter-subscription-form.webp',
        'import_notice'                => esc_html__( 'Contact Form 7 plugin should be installed and activated in order to import & use the forms.', 'essentials' ),
    );
    array_push($data, $demo);

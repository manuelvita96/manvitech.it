...
if (!empty($header_data->val)) {
    if (!empty($header_data->val->header_1)) {
        ...
        if (!empty($background) && $background === 'custom' && !empty($custom_background)) {
            $customStyle .= '.pix-header.pix-header-desktop { background: ' . $custom_background . '; }';
        }
...
?>
        ...
        ?>
        <header id="masthead" class="pix-header <?php echo esc_attr($header_sticky); ?> <?php echo esc_attr($headerClasses); ?> pix-header-desktop d-block pix-header-normal pix-scroll-shadow  header-scroll pix-header-container-area bg-<?php echo esc_attr($background); ?>" data-text="<?php echo esc_attr($color); ?>" data-text-scroll="<?php echo esc_attr($scroll_color); ?>" data-bg-class="<?php echo esc_attr($bg); ?>" data-scroll-class="<?php echo esc_attr($scroll); ?>" data-scroll-color="<?php echo esc_attr($custom_scroll); ?>">

		...
		if ($this->plugin_page === $hook || ('admin.php' === $hook && $this->plugin_page_setup['menu_slug'] === esc_attr($_GET['import']))) {
			...
			wp_localize_script(
				...
				array(
					...
					'texts'            => array(
						'missing_preview_image' => esc_html__('No preview image defined for this import.', 'pixfort-core'),
						'dialog_title'          => esc_html__('Are you sure?', 'pixfort-core'),
						'dialog_no'             => esc_html__('Cancel', 'pixfort-core'),
						'dialog_yes'            => esc_html__('Yes, import!', 'pixfort-core'),
						'selected_import_title' => esc_html__('Selected demo import:', 'pixfort-core'),
					),
	...
	public function import_demo_data_ajax_callback() {
		...
		if (!$use_existing_importer_data) {
			...
			if (!empty($_FILES)) { // Using manual file uploads?
				...
				$this->import_files[$this->selected_index]['import_file_name'] = esc_html__('Manually uploaded files', 'pixfort-core');
				...
				if (is_wp_error($this->selected_import_files)) {
					...
					Helpers::log_error_and_send_ajax_response(
						...
						$this->log_file_path,
						esc_html__('Downloaded files', 'pixfort-core')
					);
				}
				...
				$log_added = Helpers::append_to_file(
					sprintf(
						__('The import files for: %s were successfully downloaded!', 'pixfort-core'),
				...
				wp_send_json(esc_html__('No import files specified!', 'pixfort-core'));
			}
		}

...
<div class="pix-cookie-banner position-fixed">
	<div class="pix-cookie-inner pix-px-10 pix-py-5 rounded-xl shadow-lg pix-mb-20 bg-white fly-sm shadow-hover-lg animate-in" data-anim-type="fade-in-up" data-anim-delay="1000">
		<div class="d-sm-flex align-items-center">
			...
			<a href="#" data-link="<?php echo esc_url($close_link); ?>" class="pix-cookies-close text-20 line-height-0 ml-2 d-flex align-items-center justify-content-center text-gray-4"><span class="screen-reader-text sr-only"><?php echo esc_attr__('Close', 'essentials'); ?></span>

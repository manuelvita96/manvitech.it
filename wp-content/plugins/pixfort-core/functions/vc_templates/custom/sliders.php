...
function pix_templates_sliders(){
    ...
    $data['name'] = 'Slider Bold'; // Assign name for your custom template
...
CONTENT;
    ...
    $data = array(); // Create new array
    $data['name'] = 'Slider Creative'; // Assign name for your custom template
    $data['weight'] = 0; // Weight of your template in the template list
    $data['type'] = 'default_templates'; // Weight of your template in the template list
    $data['category'] = 'default_templates'; // Weight of your template in the template list
...
CONTENT;
    ...
    $data = array(); // Create new array
    $data['name'] = 'Slider Ecommerce'; // Assign name for your custom template
    $data['weight'] = 0; // Weight of your template in the template list
    $data['type'] = 'default_templates'; // Weight of your template in the template list
    $data['category'] = 'default_templates'; // Weight of your template in the template list
...
CONTENT;
    ...
    $data = array();
    $data['name'] = 'Image slider Construction';
    $data['weight'] = 0;
    $data['type'] = 'default_templates';
    $data['category'] = 'default_templates';
...
CONTENT;
    ...
    $data = array();
    $data['name'] = 'Slider Portfolio item SHOWCASE';
    $data['weight'] = 0;
    $data['type'] = 'default_templates';
    $data['category'] = 'default_templates';
...
CONTENT;
    ...
    $data = array();
    $data['name'] = 'Slider default boxed ELEMENTS';
    $data['weight'] = 0;
    $data['type'] = 'default_templates';
    $data['category'] = 'default_templates';
...
CONTENT;
    ...
    $data = array();
    $data['name'] = 'Slider circles boxed ELEMENTS';
    $data['weight'] = 0;
    $data['type'] = 'default_templates';
    $data['category'] = 'default_templates';

...
function pix_templates_portfolio(){
    ...
    $data['name'] = 'Portfolio carousel Services'; // Assign name for your custom template
...
CONTENT;
    ...
    $data = array(); // Create new array
    $data['name'] = 'Portfolio Construction'; // Assign name for your custom template
    $data['weight'] = 0; // Weight of your template in the template list
    $data['type'] = 'default_templates'; // Weight of your template in the template list
    $data['category'] = 'default_templates'; // Weight of your template in the template list
...
CONTENT;
    ...
    $data = array();
    $data['name'] = 'Portfolio carousel Personal';
    $data['weight'] = 0;
...
CONTENT;
    ...
    $data = array();
    $data['name'] = 'Portfolio Photography';
    $data['weight'] = 0;
    $data['type'] = 'default_templates';
    $data['category'] = 'default_templates';
...
CONTENT;
    ...
    $data = array();
    $data['name'] = 'Portfolio carousel 3 Agency';
    $data['weight'] = 0;
    $data['type'] = 'default_templates';
    $data['category'] = 'default_templates';
...
CONTENT;
    ...
    $data = array();
    $data['name'] = 'Portfolio carousel 2 Agency';
    $data['weight'] = 0;
    $data['type'] = 'default_templates';
    $data['category'] = 'default_templates';
...
CONTENT;
    ...
    $data = array();
    $data['name'] = 'Portfolio Main Original';
    $data['weight'] = 0;
    $data['type'] = 'default_templates';
    $data['category'] = 'default_templates';

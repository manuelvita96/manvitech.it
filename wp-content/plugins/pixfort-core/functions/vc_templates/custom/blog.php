...
function pix_templates_blog(){
    ...
    $data['name'] = 'Blog posts Startup'; // Assign name for your custom template
...
CONTENT;
    ...
    $data = array(); // Create new array
    $data['name'] = 'Blog posts Software'; // Assign name for your custom template
    $data['weight'] = 0; // Weight of your template in the template list
    $data['type'] = 'default_templates'; // Weight of your template in the template list
    $data['category'] = 'default_templates'; // Weight of your template in the template list
...
CONTENT;
    ...
    $data = array(); // Create new array
    $data['name'] = '3 Blog posts'; // Assign name for your custom template
    $data['weight'] = 0; // Weight of your template in the template list
    $data['type'] = 'default_templates'; // Weight of your template in the template list
    $data['category'] = 'default_templates'; // Weight of your template in the template list
...
CONTENT;
    ...
    $data = array(); // Create new array
    $data['name'] = '2x2 Blog posts'; // Assign name for your custom template
    $data['weight'] = 0; // Weight of your template in the template list
    $data['type'] = 'default_templates'; // Weight of your template in the template list
    $data['category'] = 'default_templates'; // Weight of your template in the template list
...
CONTENT;
    ...
    $data = array(); // Create new array
    $data['name'] = 'Blog Event'; // Assign name for your custom template
    $data['weight'] = 0; // Weight of your template in the template list
    $data['type'] = 'default_templates'; // Weight of your template in the template list
    $data['category'] = 'default_templates'; // Weight of your template in the template list
...
CONTENT;
    ...
    $data = array(); // Create new array
    $data['name'] = 'Blog Creative'; // Assign name for your custom template
    $data['weight'] = 0; // Weight of your template in the template list
    $data['type'] = 'default_templates'; // Weight of your template in the template list
    $data['category'] = 'default_templates'; // Weight of your template in the template list
...
CONTENT;
    ...
    $data = array();
    $data['name'] = '3 Blog posts Foundation';
    $data['weight'] = 0;
...
CONTENT;
    ...
    $data = array();
    $data['name'] = '2 Blog posts Foundation';
    $data['weight'] = 0;
    $data['type'] = 'default_templates';
    $data['category'] = 'default_templates';
...
CONTENT;
    ...
    $data = array();
    $data['name'] = 'Blog carousel right business';
    $data['weight'] = 0;
    $data['type'] = 'default_templates';
    $data['category'] = 'default_templates';
...
CONTENT;
    ...
    $data = array();
    $data['name'] = 'Blog carousel left business';
    $data['weight'] = 0;
    $data['type'] = 'default_templates';
    $data['category'] = 'default_templates';
...
CONTENT;
    ...
    $data = array();
    $data['name'] = 'Blog posts Coronavirus';
    $data['weight'] = 0;
    $data['type'] = 'default_templates';
    $data['category'] = 'default_templates';
...
CONTENT;
    ...
    $data = array();
    $data['name'] = 'Posts carousel Personal';
    $data['weight'] = 0;
    $data['type'] = 'default_templates';
    $data['category'] = 'default_templates';
...
CONTENT;
    ...
    $data = array();
    $data['name'] = 'Blog posts Influencer';
    $data['weight'] = 0;
    $data['type'] = 'default_templates';
    $data['category'] = 'default_templates';
...
CONTENT;
    ...
    $data = array();
    $data['name'] = 'Blog carousel Blogger';
    $data['weight'] = 0;
    $data['type'] = 'default_templates';
    $data['category'] = 'default_templates';
...
CONTENT;
    ...
    $data = array();
    $data['name'] = 'Posts with right sidebar Blogger';
    $data['weight'] = 0;
    $data['type'] = 'default_templates';
    $data['category'] = 'default_templates';
...
CONTENT;
    ...
    $data = array();
    $data['name'] = 'Posts with left sidebar Blogger';
    $data['weight'] = 0;
    $data['type'] = 'default_templates';
    $data['category'] = 'default_templates';
...
CONTENT;
    ...
    $data = array();
    $data['name'] = 'Posts center Blogger';
    $data['weight'] = 0;
    $data['type'] = 'default_templates';
    $data['category'] = 'default_templates';
...
CONTENT;
    ...
    $data = array();
    $data['name'] = 'Blog posts carousel Knowledge base';
    $data['weight'] = 0;
    $data['type'] = 'default_templates';
    $data['category'] = 'default_templates';
...
CONTENT;
    ...
    $data = array();
    $data['name'] = 'Blog carousel Main Original';
    $data['weight'] = 0;
    $data['type'] = 'default_templates';
    $data['category'] = 'default_templates';
...
CONTENT;
    ...
    $data = array();
    $data['name'] = 'Blog Home Digital Agency';
    $data['weight'] = 0;
    $data['type'] = 'default_templates';
    $data['category'] = 'default_templates';
...
CONTENT;
    ...
    $data = array();
    $data['name'] = 'Blog Home Consulting';
    $data['weight'] = 0;
    $data['type'] = 'default_templates';
    $data['category'] = 'default_templates';

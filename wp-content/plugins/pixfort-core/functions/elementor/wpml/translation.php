...
add_action( 'elementor/init', function() {
    ...
    include_once('items/testimonials-slider.php');
}, 15 );
/**
...
function pix_wpml_widgets_to_translate_list($widgets) {
    ...
    $widgets['pix-button'] = array(
        ...
        'fields'     => array(
            ...
            array(
                'field'       => 'btn_link',
                'type'        => __('Button Link', 'pixfort-core'),
                'editor_type' => 'LINE'
            ),
        ),
    );
    ...
    $widgets['pix-fancybox'] = array(
        ...
        'fields'     => array(
            ...
            array(
                'field'       => 'link',
                'type'        => __('Fancybox link', 'pixfort-core'),
                'editor_type' => 'LINE'
            ),
        ),
    );
    ...
    $widgets['pix-feature'] = array(
        ...
        'fields'     => array(
            ...
            array(
                'field'       => 'link',
                'type'        => __('Feature link', 'pixfort-core'),
                'editor_type' => 'LINE'
            ),
        ),
    );
    ...
    $widgets['pix-img'] = array(
        ...
        'fields'     => array(
            ...
            array(
                'field'       => 'link',
                'type'        => __('Image link', 'pixfort-core'),
                'editor_type' => 'LINE'
            ),
        ),
    );
    ...
    $widgets['pix-photo-box'] = array(
        ...
        'fields'     => array(
            ...
            array(
                'field'       => 'link',
                'type'        => __('Photo box link', 'pixfort-core'),
                'editor_type' => 'LINE'
            ),
        ),
    );
    ...
    $widgets['pix-testimonials-slider'] = array(
        ...
        'fields'     => array(),
        'integration-class' => 'Pix_WPML_Elementor_TESTIMONIALS_SLIDER',
    );
    ...
    $widgets['pix-testimonial'] = array(
        ...
        'fields'     => array(
            ...
            array(
                'field'       => 'link',
                'type'        => __('Testimonial link', 'pixfort-core'),
                'editor_type' => 'LINE'
            ),
        ),
    );

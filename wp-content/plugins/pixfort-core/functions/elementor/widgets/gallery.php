...
class Pix_Eor_Gallery extends Widget_Base {
	...
	public function __construct($data = [], $args = null) {
	  ...
	  if (is_user_logged_in()) wp_enqueue_style( 'pixfort-masonry-style', PIX_CORE_PLUGIN_URI.'functions/css/elements/css/masonry.min.css', false, PIXFORT_PLUGIN_VERSION);
   	}

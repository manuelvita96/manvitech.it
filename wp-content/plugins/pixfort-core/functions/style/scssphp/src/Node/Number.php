...
namespace PixScssPhp\ScssPhp\Node;

use PixScssPhp\ScssPhp\Base\Range;
use PixScssPhp\ScssPhp\Compiler;
use PixScssPhp\ScssPhp\Exception\RangeException;
use PixScssPhp\ScssPhp\Exception\SassScriptException;
use PixScssPhp\ScssPhp\Node;
use PixScssPhp\ScssPhp\Type;
use PixScssPhp\ScssPhp\Util;
...
class Number extends Node implements \ArrayAccess
{
     ...
     * Output number
     *
     * @param \PixScssPhp\ScssPhp\Compiler $compiler
     *
     * @return string
     */

...
namespace PixScssPhp\ScssPhp;

use PixScssPhp\ScssPhp\Base\Range;
use PixScssPhp\ScssPhp\Block\AtRootBlock;
use PixScssPhp\ScssPhp\Block\CallableBlock;
use PixScssPhp\ScssPhp\Block\DirectiveBlock;
use PixScssPhp\ScssPhp\Block\EachBlock;
use PixScssPhp\ScssPhp\Block\ElseBlock;
use PixScssPhp\ScssPhp\Block\ElseifBlock;
use PixScssPhp\ScssPhp\Block\ForBlock;
use PixScssPhp\ScssPhp\Block\IfBlock;
use PixScssPhp\ScssPhp\Block\MediaBlock;
use PixScssPhp\ScssPhp\Block\NestedPropertyBlock;
use PixScssPhp\ScssPhp\Block\WhileBlock;
use PixScssPhp\ScssPhp\Compiler\CachedResult;
use PixScssPhp\ScssPhp\Compiler\Environment;
use PixScssPhp\ScssPhp\Exception\CompilerException;
use PixScssPhp\ScssPhp\Exception\ParserException;
use PixScssPhp\ScssPhp\Exception\SassException;
use PixScssPhp\ScssPhp\Exception\SassScriptException;
use PixScssPhp\ScssPhp\Formatter\Compressed;
use PixScssPhp\ScssPhp\Formatter\Expanded;
use PixScssPhp\ScssPhp\Formatter\OutputBlock;
use PixScssPhp\ScssPhp\Logger\LoggerInterface;
use PixScssPhp\ScssPhp\Logger\StreamLogger;
use PixScssPhp\ScssPhp\Node\Number;
use PixScssPhp\ScssPhp\SourceMap\SourceMapGenerator;
use PixScssPhp\ScssPhp\Util\Path;
...
class Compiler
{
    ...
    /**
     * @var \PixScssPhp\ScssPhp\Compiler\Environment
     */
    protected $env;
    /**
     * @var OutputBlock|null
     ...
     * @param string|null $path
     *
     * @return \PixScssPhp\ScssPhp\Parser
     */
     ...
     *
     * @return \PixScssPhp\ScssPhp\Formatter\OutputBlock
     */
     ...
     * Compile root
     *
     * @param \PixScssPhp\ScssPhp\Block $rootBlock
     *
     * @return void
     */
     ...
     * Flatten selectors
     *
     * @param \PixScssPhp\ScssPhp\Formatter\OutputBlock $block
     ...
     * Compile media
     *
     * @param \PixScssPhp\ScssPhp\Block $media
     *
     * @return void
     */
     ...
     * Media parent
     *
     * @param \PixScssPhp\ScssPhp\Formatter\OutputBlock $scope
     *
     * @return \PixScssPhp\ScssPhp\Formatter\OutputBlock
     */
     ...
     * @param \PixScssPhp\ScssPhp\Formatter\OutputBlock $out
     *
     * @return void
     */
     ...
     * Compile at-root
     *
     * @param \PixScssPhp\ScssPhp\Block $block
     *
     * @return void
     */
     ...
     *
     * @param \PixScssPhp\ScssPhp\Formatter\OutputBlock $scope
     * @param \PixScssPhp\ScssPhp\Formatter\OutputBlock $previousScope
     *
     * @return OutputBlock
     */
     ...
     * Filter WITH rules
     *
     * @param \PixScssPhp\ScssPhp\Block|\PixScssPhp\ScssPhp\Formatter\OutputBlock $block
     * @param array                                                         $with
     * @param array                                                         $without
     *
     * @return bool
     ...
     * @param array[]                                $stms
     * @param \PixScssPhp\ScssPhp\Formatter\OutputBlock $out
     * @param \PixScssPhp\ScssPhp\Block                 $selfParent
     * @param string                                 $traceName
     *
     * @return void
     *
...
EOL;
     ...
     *
     * @param \PixScssPhp\ScssPhp\Compiler\Environment $env
     * @param \PixScssPhp\ScssPhp\Block                $selfParent
     *
     * @return array
     */
     ...
     * @param \PixScssPhp\ScssPhp\Block $block
     *
     * @return \PixScssPhp\ScssPhp\Compiler\Environment
     */
    ...
    public function addVariables(array $variables)
    {
        ...
        if ($triggerWarning) {
            @trigger_error('Passing raw values to as custom variables to the Compiler is deprecated. Use "\PixScssPhp\ScssPhp\ValueConverter::parseValue" or "\PixScssPhp\ScssPhp\ValueConverter::fromPhp" to convert them instead.', E_USER_DEPRECATED);
        }
    }
     ...
     *
     * @return \PixScssPhp\ScssPhp\Compiler
     *
     ...
     * @return never
     *
     * @throws \PixScssPhp\ScssPhp\Exception\CompilerException
     *

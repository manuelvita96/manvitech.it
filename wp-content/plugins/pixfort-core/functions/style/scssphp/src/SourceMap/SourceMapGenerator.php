...
namespace PixScssPhp\ScssPhp\SourceMap;
...
class SourceMapGenerator
{
     ...
     *
     * @var \PixScssPhp\ScssPhp\SourceMap\Base64VLQ
     */
    protected $encoder;
     ...
     * @return string|null
     *
     * @throws \PixScssPhp\ScssPhp\Exception\CompilerException If the file could not be saved
     * @deprecated
     */
